...
root1.configure(bg="#643843",width=100)
root1.resizable(False,False)
frame = tk.Frame(bg='black')
image = Image.open("stockk.jpg")
    ...
    if len(rows) > 0:
        ...
        if cursor: 
          ...
          mainapp.main()
            ...
            # show error message
         error = messagebox.showerror("Error", "Invalid Username Or Password. Please Create Account!")
         username_entry.delete(0, 'end')
         password_entry.delete(0, 'end')
...
login_label = tk.Label(frame, text="Login To Your Account", bg='black', fg="#99627A", font=("Jokerman", 30))
...
login_button = tk.Button(
    frame, text="Login", bg="#C88EA7", fg="#FFFFFF", font=("Jokerman", 16), command=Login)
login_button.grid(row=3, column=0, columnspan=2, pady=30)
signup_button = tk.Button(
    frame, text="Signup >>", bg="#E7CBCB", fg="black", font=("Jokerman", 16), command=go_to_signup)

# Create buttons for login and signup

signup_button.place(x=335,y=303)
style = ttk.Style()
